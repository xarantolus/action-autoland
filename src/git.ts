...
export class Reference {
    ...
    // private repoInfo(fallbackOwner:string, fallbackRepo :string) {
    //     if (this.repoSlug) {
    ...
    // public isSatisfied(client: InstanceType<typeof GitHub>, baseRepoSlug: string): boolean {
    //     const repoSlug = this.repoSlug || baseRepoSlug;
