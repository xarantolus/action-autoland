...
test("ref parsing correctness", () => {
    ...
    expect(Reference.parse("other/repo#7057a654720ef532ad11f920e57a33f59890d702")).toEqual({
        repoSlug: "other/repo",
    ...
    expect(
        Reference.parse("#7057a654720ef532ad11f920e57a33f59890d702")
    ).toEqual({
        commitHash: "7057a654720ef532ad11f920e57a33f59890d702"
    })
